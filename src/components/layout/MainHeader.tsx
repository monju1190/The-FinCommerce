...
export default function MainHeader() {
  ...
  return (
    <div className="w-full relative z-50">
      <nav className="w-full flex items-center justify-between px-6 md:px-12 py-6 md:py-8 max-w-[1400px] mx-auto bg-white/90 backdrop-blur-md">
        {/* Left: Search Icon */}
        ...
        <div className="flex-1 flex justify-end items-center space-x-4" data-purpose="social-links">
          ...
          <a href="#" className="text-gray-800 hover:text-black hidden sm:block">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.761 0 5-2.239 5-5v-14c0-2.761-2.239-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"></path></svg>
          </a>
          <button 
            className="md:hidden text-gray-800 hover:text-black ml-4 focus:outline-none"
      ...
      {isMobileMenuOpen && (
        <div className="absolute top-[80px] left-0 w-full bg-white border-t border-gray-100 shadow-lg p-6 flex flex-col space-y-6 md:hidden text-center text-sm font-bold tracking-widest uppercase">
      ...
      {/* BEGIN: Masthead */}
      <header className="w-full text-center py-6 md:py-16 px-4">
        <h1 className="font-[900] tracking-tight leading-[0.9] text-[9.5vw] sm:text-[9vw] md:text-[8vw] lg:text-[7rem] xl:text-[8.5rem] uppercase select-none text-gray-900 break-words">
          The FinCommerce
        </h1>
      </header>
      {/* END: Masthead */}
