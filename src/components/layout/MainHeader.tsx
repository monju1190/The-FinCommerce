...
export default function MainHeader() {
  ...
  return (
    <>
      ...
      <div className="w-full text-center pt-12 pb-8 px-4 bg-[var(--color-ft-pink)] flex flex-col items-center justify-center relative">
        <h1 className="font-black tracking-tighter leading-[0.8] text-[13vw] md:text-[120px] lg:text-[160px] uppercase select-none text-gray-900 font-display pb-4 inline-block opacity-90 mix-blend-multiply">
          The FinCommerce
        </h1>
        <div className="w-full max-w-4xl border-t border-gray-400 mt-4 flex items-center justify-between pt-3 text-[10px] font-bold tracking-widest uppercase text-gray-600 font-sans">
